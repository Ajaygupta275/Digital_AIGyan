    ...
    <>
      <div className='bg-[#dddbdb] w-[100vw] h-[100vh] flex
        ...
        <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl
                           rounded-2xl flex' onClick={(e)=>e.preventDefault()}>
          {/* Left Div */}
          ...
          <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col
            ...
            <button className='w-[80%] h-[40px] bg-black text-white
                    cursor-pointer flex items-center justify-center rounded-[5px]' onClick={handleLogin} disabled={loading} >
                 {loading ?<ClipLoader size={30} color="white"/>: "Login"}
            </button>
             <span className='text-[18px] cursor-pointer text-[#585757] '>Forget Your Password</span>
            ...
            <div className='w-[80%] h-[40px] border-1 border-[black] rounded-[5px] flex items-center justify-center'>
              ...
              <span className='text-[18px] cursor-pointer'>oogle</span>
               ...
               <span className='underline underline-offset-1 text-[black] cursor-pointer' onClick={() => navigate("/signup")}>Login</span>
              </div>
          </div>
