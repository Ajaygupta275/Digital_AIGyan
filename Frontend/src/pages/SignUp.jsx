      ...
      <div className='bg-[#dddbdb] w-[100vw] h-[100vh] flex
        ...
        <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl
          ...
          <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col
            ...
            <div>
              ...
              <div className='flex flex-col gap-1 w-[80%] items-start justify-center px-3'>
                ...
                <input id='email' type='email' className='border-1 w-[100%] h-[35px] border-[#e7e6e6] text-[15px] px-[20px]' 
              ...
              <div className='flex flex-col gap-1 w-[80%] items-start justify-center px-3 relative'>
                ...
                />
                {show ?<IoIosEye className='absolute w-[20px] h-[20px] cursor-pointer right-[5%] bottom-[10%]' onClick={()=>setShow(prev=>!prev)} />: 
                <IoIosEyeOff className='absolute w-[20px] h-[20px] cursor-pointer right-[5%] bottom-[10%]' onClick={()=>setShow(prev=>!prev)} />}
              </div>

              <div className='flex md:w-[50%] w-[70%] items-center justify-between'>
                <span className={`px-[10px] py-[5px] border-[2px] border-[#e7e6e6] rounded-xl
                 cursor-pointer hover:border-black ${role==="student" ? "border-black" :"border-[#646464]"}`} onClick={()=>setRole("student")}>Student</span>
                <span className={`px-[10px] py-[5px] border-[2px] border-[#e7e6e6] rounded-xl
                 cursor-pointer hover:border-black ${role==="educator" ? "border-black" :"border-[#646464]"} `} onClick={()=>setRole("educator")}>Educator</span>
              </div>

               <button className='w-[80%] h-[40px] bg-black text-white
                cursor-pointer flex items-center justify-center rounded-[5px]' onClick={handleSignup} disabled={loading} >
              ...
              <div className='w-[80%] h-[40px] border-1 border-[black] rounded-[5px] flex items-center justify-center'>
                <img src={google} alt='Google-image' className='w-[25px]'/>
                <span className='text-[18px] cursor-pointer'>oogle</span>
              </div>
          ...
          <div className='w-[50%] h-[100%] rounded-r-2xl bg-[black] md:flex items-center justify-center flex-col hidden'>
            ...
            <span className='text-3xl text-white'>Digital Ai Gyan</span>
